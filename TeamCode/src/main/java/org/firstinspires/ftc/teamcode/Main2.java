...
public class Main2 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        robot.flywheel1.setVelocityPIDFCoefficients(1000, 0, 0, 17); //17
        robot.flywheel2.setVelocityPIDFCoefficients(1000, 0, 0, 17);  //17
        ...
        while (opModeIsActive()) {
            ...
            } else if (gamepad2.dpad_Up) { //was: d pad_down edit: reverted
                robot.lift1.setPower(leg1);
                robot.lift2.setPower(leg2);
            } else {
